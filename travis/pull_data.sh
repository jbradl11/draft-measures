...
cd ..
ls
calculate-bundles -d ./fhir-patient-generator/EXM_130/patients-r4/ -c ./pages/cql/in-progress/fhir4/EXM130_FHIR4-7.2.000.cql -u http://localhost:8080/cqf-ruler-r4
